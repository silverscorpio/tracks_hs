...
'''
SAMPLE_JSON_DATA_ON_DEMAND_1: str = '''
[
    {
        "bus_id": 128,
        "stop_id": 1,
...
SAMPLE_JSON_DATA_ON_DEMAND_2: str = '''
[
    {
        "bus_id": 512,
        "stop_id": 4,
...
'''
SAMPLE_JSON_DATA_ON_DEMAND_3: str = '''
...
def main():
    # json_data_input = SAMPLE_JSON_DATA_ON_DEMAND_3
    ...
    # validator.report_bus_data()
    validator.determine_bus_stops()
    # validator.check_a_time()
    validator.check_on_demand_stops()
